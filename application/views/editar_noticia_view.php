    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <br>
                <br>
                <h2 class="section-heading">Editar Noticia</h2>
                <br>
                <br>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-md-12 ">
                <?php echo form_open( "noticias_controller/editar_noticia/$id");echo form_hidden('id', $id);?>
                <div class="row ">

                    <div class="col-md-12">
                        <div class="form-group">
                             <?php echo form_label( "", "titular"); $data=array( "name"=>"titular", "id"=>"titular", "value"=>$titular, "class"=>"form-control", 'placeholder' => 'Introduce aquí el titular', ); echo form_input($data);?>

                            <p>
                                <?php form_error( 'titular')?>
                            </p>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="form-group">
                            <?php echo form_label( "", "enlace"); $data=array( "name"=>"enlace", "id"=>"enlace", "value"=>$enlace, "class"=>"form-control", 'placeholder' => 'Introduce aquí el enlace (http://...)', ); echo form_input($data);?>
                            <p>
                                <?php form_error( 'enlace')?>
                            </p>
                            <p class="help-block text-danger"></p>
                        </div>
                          <div class="form-group">
                            <?php echo form_label( "", "resumen"); $data=array( "name"=>"resumen", "id"=>"resumen", "value"=>$resumen, "class"=>"form-control", 'placeholder' => 'Introduce aquí el resumen de la noticia', ); echo form_textarea($data);?>
                            <p>
                                <?php form_error( 'resumen')?>
                            </p>
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
