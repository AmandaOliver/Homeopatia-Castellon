    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <br>
                <br>
                <h2 class="section-heading">Añadir Noticia</h2>
                <br>
                <br>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-md-12 ">
                <?php echo form_open( "noticias_controller/insertar_noticia");?>
                <div class="row ">

                    <div class="col-md-12">
                        <div class="form-group">
                            <?php echo form_label( "", "titular"); $data=array( "name"=>"titular", "id"=>"titular", "value"=>"", "class"=>"form-control", 'placeholder' => 'Introduce aquí el titular', ); echo form_input($data);?>
                            <p>
                        ...
                        <div class="form-group">
                            <?php echo form_label( "", "enlace"); $data=array( "name"=>"enlace", "id"=>"enlace", "value"=>"", "class"=>"form-control", 'placeholder' => 'Introduce aquí el enlace (http://...)', ); echo form_input($data);?>
                            <p>
                        ...
                        <div class="form-group">
                            <?php echo form_label( "", "resumen"); $data=array( "name"=>"resumen", "id"=>"resumen", "value"=>"", "class"=>"form-control", 'placeholder' => 'Introduce aquí el resumen de la noticia', ); echo form_textarea($data);?>
                            <p>
