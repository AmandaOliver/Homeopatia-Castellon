        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="<?php echo base_url();?>administrador_controller">Menú principal</a>
                    </li>
                    <li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <br>
                <br>
                <h2 class="section-heading">Añadir entrada del Blog</h2>
                <br>
                <br>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-md-12 ">
                <?php echo form_open( "blog_controller/insertar_entrada");?>
                <div class="row ">

                    <div class="col-md-12">
                        <div class="form-group">
                            <?php echo form_label( "", "titulo"); $data=array( "name"=>"titulo", "id"=>"titulo", "value"=>"", "class"=>"form-control", 'placeholder' => 'Introduce aquí el nombre de esta entrada del blog', ); echo form_input($data);?>
                            <p>
                        ...
                        <div class="form-group">
                            <?php echo form_label( "", "cuerpo"); $data=array( "name"=>"cuerpo", "id"=>"cuerpo", "value"=>"", "class"=>"form-control", 'placeholder' => 'Introduce aquí el texto de la entrada del blog', ); echo form_textarea($data);?>
                            <p>
