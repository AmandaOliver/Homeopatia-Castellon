    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <br>
                <br>
                <h2 class="section-heading">Editar Libro</h2>
                <br>
                <br>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-md-12 ">
                <?php echo form_open( "libros_controller/editar_libro/$id");echo form_hidden( 'id', $id);?>
                <div class="row ">

                    <div class="col-md-12">
                        <div class="form-group">
                            <?php echo form_label( "", "titulo"); $data=array( "name"=>"titulo", "id"=>"titulo", "value"=>$titulo, "class"=>"form-control", 'placeholder' => 'Introduce aquí el titulo del libro', ); echo form_input($data);?>
                            <p>
                        ...
                        <div class="form-group">
                            <?php echo form_label( "", "editorial"); $data=array( "name"=>"editorial", "id"=>"editorial", "value"=>$editorial, "class"=>"form-control", 'placeholder' => 'Introduce aquí la editorial del libro', ); echo form_input($data);?>
                            <p>
                                <?php form_error( 'editorial')?>
                            </p>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="form-group">
                            <?php echo form_label( "", "autor"); $data=array( "name"=>"autor", "id"=>"autor", "value"=>$autor, "class"=>"form-control", 'placeholder' => 'Introduce aquí el nombre del autor', ); echo form_input($data);?>
                            <p>
                                <?php form_error( 'autor')?>
                            </p>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="form-group">
                            <?php echo form_label( "", "sinopsis"); $data=array( "name"=>"sinopsis", "id"=>"sinopsis", "value"=>$sinopsis, "class"=>"form-control", 'placeholder' => 'Introduce aquí la sinopsis del libro', ); echo form_textarea($data);?>
                            <p>
                                <?php form_error( 'sinopsis')?>
                            </p>
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
