    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <br>
                <br>
                <h2 class="section-heading">Editar o Eliminar Noticias</h2>
                <br>
                <br>
            </div>
        </div>
            ...
            <div class="col-md-12 ">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <?php if($noticias!=FALSE){ foreach($noticias as $row){?>
                        <tr>
                            <td>
                                <?php echo $row->titular;?>
                            </td>
                            <td>
                                <a href="<?php echo base_url();?>noticias_controller/eliminar_noticia/<?php echo $row->id;?>">Eliminar</a>
                            </td>
                            <td>
                                <a href="<?php echo base_url();?>menu_controller/editar_noticia/<?php echo $row->id;?>">Editar</a>
                            </td>
                        </tr>
                        <?php } }else echo "No hay noticias";?>
                    </table>
                </div>
                <div class="row text-center">
                    <div class="btn-group" role="group" aria-label="...">
                        <?php $n=$pn-1; if($n>0){echo '<a class="btn btn-noticias" role="button" href='.base_url(). 'menu_controller/pagina_noticias/'.$n. ' > Anterior </a>';} for($i=1;$i
                        <=$paginas_noticias;$i++){ ?>

                            <a class="btn btn-noticias" role="button" href=<?php echo base_url();?>menu_controller/pagina_noticias/<?php echo $i;?>>
                            <?php if ($pn==$i)
                            ...
                            <?php } $n=$pn+1; if($n<=$paginas_noticias){ echo '<a class="btn btn-noticias" role="button" href='.base_url(). 'menu_controller/pagina_noticias/'.$n. ' > Siguiente </a>';}?>
                    </div>
